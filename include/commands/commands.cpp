...
std::unordered_map<std::string_view, std::function<void(ENetEvent&, const std::string_view)>> cmd_pool
{
    ...
    {
        action(*event.peer, "log", "msg|>> Commands: /find /weather {0-100} /warp {world name} /wave /dance /love /sleep /facepalm /fp /smh /yes /no /omg /idk /shrug /furious /rolleyes /foldarms /stubborn /fold /dab /sassy /dance2 /march /grumpy /shy");
    }},
    {"find", &find},
    {"warp", &warp},
    {"weather", &weather},
